...
export default function page() {
  return (
    <div>
      <div className="max-w-3xl m-auto mt-36">
        <h1 className="text-6xl font-bold mb-28 -ml-20">
        ...
        <p className="text-xl font-light mb-20">
          ...
          tellus luctus. Integer id imperdiet eros. Praesent mollis cursus nisl
          non volutpat. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Fusce auctor, elit imperdiet feugiat sagittis, ante lorem finibus leo,
          in lobortis nulla felis ut tellus. Vivamus non congue magna. In quam
          ...
          cursus dui eu risus vestibulum dapibus. Cras scelerisque eget nulla eu
          aliquam. Maecenas tempor ipsum ac est dapibus, a faucibus lacus
          consectetur. Maecenas et tellus sed turpis cursus aliquam. Aliquam at
          fringilla libero. Pellentesque ut turpis commodo, mattis augue sit
          amet, vehicula nisi. Morbi faucibus est sagittis tincidunt auctor.
          Cras sed lobortis orci. In congue et mauris in accumsan. Phasellus
          vitae tempus tellus, quis tempor mi. Phasellus ullamcorper iaculis
          risus quis tempor. Praesent iaculis justo ut risus elementum, sed
